...
def train_and_save():
    ...
    # Try local CSV first, else use bundled data path
    LOCAL_CSV = r'C:\Users\shivangi\AppData\Local\Packages\5319275A.WhatsAppDesktop_cv1g1gvanyjgm\LocalState\sessions\19D166E48B9FD5BF5C444E5369002F3D6F6D7EB0\transfers\2026-17\Graphura_Audit_Augmented_500.csv'
    BUNDLED_CSV = os.path.join(os.path.dirname(__file__), 'data', 'Graphura_Audit_Augmented_500.csv')
    ...
    if os.path.exists(LOCAL_CSV):
        ...
        raise FileNotFoundError("CSV not found! Put Graphura_Audit_Augmented_500.csv in graphura_flask/data/ folder")
